        ...
        <div className="container mx-auto px-4 mt-20">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 park">
              ...
              <button onClick={} className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-transparent border-2 border-white hover:bg-white hover:text-gray-900 text-white font-semibold rounded-4xl transition duration-300 transform hover:scale-105 group">
