...
const TestimonialSlider = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-white py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="flex justify-center mt-3 sm:mt-4">
            <button
              ...
              className="text-[10px] sm:text-xs text-gray-500 hover:text-[#18403C] transition-colors"
            >
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <p className="text-xs sm:text-sm text-gray-500 mb-3 sm:mb-4">Trusted by leading companies</p>
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 opacity-60">
            <span className="text-gray-400 font-semibold text-xs sm:text-sm">Tech Mahindra</span>
            <span className="text-gray-400 font-semibold text-xs sm:text-sm">Amazon India</span>
            <span className="text-gray-400 font-semibold text-xs sm:text-sm">Reliance</span>
            <span className="text-gray-400 font-semibold text-xs sm:text-sm">Microsoft</span>
            <span className="text-gray-400 font-semibold text-xs sm:text-sm">Google</span>
          </div>
        </div>
      </div>
    </div>
