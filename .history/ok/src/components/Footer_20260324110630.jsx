...
const Footer = () => {
  ...
  const services = [
    { name: "Staffing & Recruitment", path: "/services/staffing" },
    ...
    { name: "Third-Party Inspections", path: "/services/inspections" },
    { name: "Safety Audits", path: "/services/safety" },
  ];
  ...
  return (
    <footer className="relative text-white park">
      ...
      >
        {/* Dark Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a2a27]/95 to-[#0a2a27]/98"></div>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-lg">
                <span className="text-2xl font-bold text-[#18403C]">Z</span>
              </div>
              <div>
                <h2 className="text-2xl font-bold">Zenon Hiring</h2>
