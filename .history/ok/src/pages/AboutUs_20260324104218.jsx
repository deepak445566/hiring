...
const AboutUs = () => {
  ...
  const team = [
    {
      ...
      bio: "Visionary leader with extensive experience in talent acquisition"
    },
    {
      name: "Priya Verma",
      ...
      bio: "Expert in workforce planning and organizational development"
    },
    {
      name: "Rajesh Kumar",
      position: "Technical Recruitment Head",
      experience: "10+ Years Experience",
      image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&h=500&fit=crop",
      bio: "Specialist in IT and technical talent acquisition"
    },
    {
      name: "Neha Gupta",
      ...
      bio: "Building strong client partnerships and satisfaction"
    }
  ];

  const milestones = [
    { year: "2018", title: "Company Founded", description: "Zenon Hiring Solution established in Noida", icon: FaCalendarAlt },
    { year: "2019", title: "First 100 Placements", description: "Achieved 100 successful placements", icon: FaUsers },
    { year: "2021", title: "Expanded Services", description: "Added specialized recruitment services", icon: FaBriefcase },
    { year: "2023", title: "1000+ Placements", description: "Crossed 1000 placements milestone", icon: FaTrophy },
    { year: "2024", title: "Pan-India Presence", description: "Expanded operations across India", icon: FaGlobe }
  ];
  ...
  return (
    <div className="bg-white min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-[#18403C] transition-all duration-300">
                  View Our Services
                </button>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative fade-up-element" id="who-we-are-image">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white rounded-xl p-4 shadow-xl">
              <FaQuoteLeft className="text-[#18403C] text-3xl mb-2" />
              <p className="text-sm text-gray-600 max-w-xs">Your trusted partner in recruitment excellence</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Our Journey Section */}
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-12 fade-up-element" id="journey-header">
          <h2 className="text-3xl md:text-4xl font-bold text-[#18403C] mb-4">
            Our Journey
          </h2>
          <div className="w-20 h-1 bg-gradient-to-r from-[#18403C] to-[#2c6b64] mx-auto mb-6 rounded-full"></div>
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-[#18403C] to-[#2c6b64] hidden md:block"></div>
          ...
          <div className="space-y-8 md:space-y-12">
            {milestones.map((milestone, index) => {
              ...
              return (
                <div 
                  key={index}
                  className={`flex flex-col md:flex-row items-center gap-6 md:gap-8 fade-up-element`}
                  id={`milestone-${index}`}
                  style={{
                    opacity: visibleElements[`milestone-${index}`] ? 1 : 0,
                    transform: visibleElements[`milestone-${index}`] ? "translateY(0)" : "translateY(30px)",
                    transition: `all 0.6s cubic-bezier(0.4, 0, 0.2, 1) ${index * 0.1}s`
                  }}
                >
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:text-right' : 'md:order-last md:text-left'} text-center md:text-left`}>
                    <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                      <h3 className="text-xl font-bold text-[#18403C] mb-2">{milestone.title}</h3>
                      <p className="text-gray-600">{milestone.description}</p>
                    </div>
                  </div>
                  <div className="relative z-10 bg-[#18403C] rounded-full w-12 h-12 flex items-center justify-center shadow-lg">
                    <IconComponent className="text-white text-xl" />
                  </div>
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:order-last' : ''} text-center md:text-left`}>
                    <div className="inline-block bg-gradient-to-r from-[#18403C] to-[#2c6b64] text-white px-4 py-2 rounded-full font-bold">
                      {milestone.year}
                    </div>
                  </div>
                </div>
      ...
      <div className="bg-gray-50 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 fade-up-element" id="team-header">
            <h2 className="text-3xl md:text-4xl font-bold text-[#18403C] mb-4">
              Meet Our Leadership
            </h2>
            <div className="w-20 h-1 bg-gradient-to-r from-[#18403C] to-[#2c6b64] mx-auto mb-6 rounded-full"></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {team.map((member, index) => (
              <div 
                key={index}
                className="group fade-up-element"
                id={`team-${index}`}
                style={{
                  opacity: visibleElements[`team-${index}`] ? 1 : 0,
                  transform: visibleElements[`team-${index}`] ? "translateY(0)" : "translateY(30px)",
                  transition: `all 0.6s cubic-bezier(0.4, 0, 0.2, 1) ${index * 0.1}s`
                }}
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                  ...
                  <div className="p-5">
                    <h3 className="text-xl font-bold text-[#18403C] mb-1">{member.name}</h3>
                    <p className="text-[#2c6b64] font-medium text-sm mb-2">{member.position}</p>
        ...
        <div className="relative bg-gradient-to-r from-[#18403C] to-[#2c6b64] rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="relative p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-white text-white px-6 md:px-8 py-2.5 md:py-3 rounded-full font-semibold hover:bg-white hover:text-[#18403C] transition-all duration-300">
                View Our Services
              </button>
            </div>
          </div>
