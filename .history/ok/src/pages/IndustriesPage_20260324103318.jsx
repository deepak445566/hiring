...
const IndustriesPage = () => {
  ...
  const industries = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1593948363156-6f75f4f70b1f?w=600&h=400&fit=crop",
        ...
        <div className="relative bg-gradient-to-r from-[#18403C] to-[#2c6b64] rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="relative p-8 md:p-12 text-center">
            ...
            <p className="text-white/90 text-base md:text-lg mb-6 max-w-2xl mx-auto">
              Partner with us for innovative staffing and inspection solutions tailored to your industry needs
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
