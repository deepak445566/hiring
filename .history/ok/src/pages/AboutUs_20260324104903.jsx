        ...
        <div className="relative bg-gradient-to-r from-[#18403C] to-[#2c6b64] rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="relative p-8 md:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button on className="border-2 border-white text-white px-6 md:px-8 py-2.5 md:py-3 rounded-full font-semibold hover:bg-white hover:text-[#18403C] transition-all duration-300">
                View Our Services
              </button>
            </div>
          </div>
